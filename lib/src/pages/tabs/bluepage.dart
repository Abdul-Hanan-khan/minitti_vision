...
class _BluePageState extends State<BluePage> {
  ...
  RxBool isEcgIsOnGoing = false.obs;
      ...
      children: [
        ...
        Container(
          margin: EdgeInsets.symmetric(horizontal: 20),
            ...
            child: RealisticECGWidget(isRunning: isEcgIsOnGoing)),

        ElevatedButton(onPressed: (){
          isEcgIsOnGoing.value = !isEcgIsOnGoing.value ;
        }, child: Obx(()=> Text("${isEcgIsOnGoing.value?"Stop":"Start"} Wave")))
      ],
    );
  }
