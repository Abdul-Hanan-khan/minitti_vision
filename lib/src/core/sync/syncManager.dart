...
class SyncManager {
  ...
  void batteryCatchChargeStatus(bool isCharging, String batterLevel) {
    if (!_batteryController.isCompleted) {
      BatteryChargingStatus batteryChargingStatus = BatteryChargingStatus(isCharging,batterLevel);
